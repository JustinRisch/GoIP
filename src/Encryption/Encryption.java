...
public class Encryption {
	...
	public static String superDecrypt(String start, int i) {

		for (int j = 0; j < i; j++) {
			start = superDecrypt(start);
		}
		return start;
	}
	...
	@Deprecated
	// Strangely, this does not seem to work over a connection.
	...
	@Deprecated
	// strangely, this method does not seem to work over the net.
	...
	// very secure, but slow and limited in scalability.
